...
def app():
    ...
    with st.form("my_form"):
        ...
        selected_objects = st.multiselect('Choose objects to detect', object_names, default=['A']) 
    ...
    if uploaded_file is not None: 
        ...
        video_stream = cv2.VideoCapture(input_path)  # Use input_path instead of hardcoded 'video.mp4'
